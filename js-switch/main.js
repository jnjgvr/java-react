var diasMes = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'];
// const ejercicio1 = (diaMes:number) => console.log(diasMes[diaMes-1]);
var ejercicio1 = function (diaMes) {
    switch (diaMes) {
        case 1:
